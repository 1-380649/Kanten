...
# ----------------------------Visualisierung eines Rechtecks um die robust detektierten 9 ROI ------------------------
'''
...
pp.show()
'''
# ----------------------------ENDE Visualisierung eines Rechtecks um die robust detektierten 9 ROI ------------------------
...
# ---------------------------- Visualisierung aller einzelnen Graphen ESF, LSF, MTF und ROI-Bild ------------------------
def plot_mtf_and_esf(temp_dir, edge, individual_id, esf, lsf, lsfs, mtf, mtfs, edge_angle, x_mtf, mtf50, mtf20, mtf10, lsfmax, lsfmin, lsfunc):
    ...
    pp.close()
# ----------------------------ENDE Visualisierung aller einzelnen Graphen ESF, LSF, MTF und ROI-Bild ------------------------

    # ----------------------------Visualisierung aller einzelnen Graphen MTF ------------------------
    '''
    ...
    # pp.close()  # Fenster schließen
    '''
    # ----------------------------ENDE Visualisierung aller einzelnen Graphen MTF ------------------------
    print(individual_id)
...
# ----------------------------Visualisierung aller Graphen in einem Diagramm ------------------------
...
# ----------------------------ENDE Visualisierung aller Graphen in einem Diagramm ------------------------
